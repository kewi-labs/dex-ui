...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.MONAD]: new Token(ChainId.MONAD, '0x0000000000000000000000000000000000000000', 18, 'UNI', 'Uniswap'), // placeholder
}

// MONAD / BSC Testnet Tokens
export const WMON = new Token(ChainId.MONAD, '0x3bd359C1119dA7Da1D913D1C4D2B7c461115433A', 18, 'WMON', 'Wrapped MON')
export const XAUt0 = new Token(ChainId.MONAD, '0x01bFF41798a0BcF287b996046Ca68b395DbC1071', 6, 'XAUt0', 'XAUt0')
export const AUSD = new Token(ChainId.MONAD, '0x00000000eFE302BEAA2b3e6e1b18d08D69a9012a', 6, 'AUSD', 'Agora Dollar')
