...
import MONAD_LIST from '../../constants/tokenLists/monad.tokenlist.json'
...
const TRANSFORMED_MONAD_LIST = listToTokenMap(MONAD_LIST)
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.MONAD]: { ...map1[ChainId.MONAD], ...map2[ChainId.MONAD] }, // BSC Testnet
  }
}
...
export function useCombinedActiveList(): TokenAddressMap {
  ...
  return combineMaps(withDefaults, TRANSFORMED_MONAD_LIST)
}
